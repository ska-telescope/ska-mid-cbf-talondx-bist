...
if __name__ == "__main__":
    ...
    args["DDR4_runtime"] = DDR4_runtime

    # DDR4 Tester module External Memory Interfaces
    DDR4_EMIFs = [
        {
            'board': "talon", 
            "EMIF": ['TR', 'BL', 'BR'],
    ...
    testcases = [   # power-on self-test
        ...
        # "DDR4_Walking_0_Pattern",
        "DDR4_Walking_1_Pattern",
        # "DDR4_Alternating_A_Pattern",
        # "DDR4_Alternating_5_Pattern",
    ]
